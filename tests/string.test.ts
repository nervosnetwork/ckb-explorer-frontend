...
describe('String methods tests', () => {
  ...
  it('start end ellipsis', async () => {
    expect(
      startEndEllipsis('0xckt1q9gry5zgmceslalm5xwn20v0krjpsugdnkkmkw5pqe5ge4'),
    ).toBe('0xckt1q9gry5zgmc...5pqe5ge4')
    expect(
      startEndEllipsis(
        '0xckt1q9gry5zgmceslalm5xwn20v0krjpsugdnkkmkw5pqe5ge4',
        16,
      ),
    ).toBe('0xckt1q9gry5zgmc...gdnkkmkw5pqe5ge4')
    expect(
      startEndEllipsis(
        '0xckt1q9gry5zgmceslalm5xwn20v0krjpsugdnkkmkw5pqe5ge4',
        3,
      ),
    ).toBe('0xckt1q9gry5zgmc...ge4')
    expect(
      startEndEllipsis(
        '0xckt1q9gry5zgmceslalm5xwn20v0krjpsugdnkkmkw5pqe5ge4',
        3,
    ...
    ).toBe('0xckt1q9gry5zgmceslalm5xwn20v0krjpsugdnkkmkw5pqe5ge4')
  ...
  it('search text correction', async () => {
    ...
    ).toBe('0x6983738437a6309ebca57186d3ae2f4ec168b4ace4abecd1625f6375633713b8')
    expect(
      addPrefixForHash(
        '6983738437a6309ebca57186d3ae2f4ec168b4ace4abecd1625f6375633713b8',
      ),
    ).toBe('0x6983738437a6309ebca57186d3ae2f4ec168b4ace4abecd1625f6375633713b8')
    // tx hash
    expect(
    ...
    ).toBe('0x56dde24a962eb5e0c77c0c0ea99cb5dfb0388012553535d447d105b96a13eeb5')
    expect(
      addPrefixForHash(
        '56dde24a962eb5e0c77c0c0ea99cb5dfb0388012553535d447d105b96a13eeb5',
      ),
    ).toBe('0x56dde24a962eb5e0c77c0c0ea99cb5dfb0388012553535d447d105b96a13eeb5')
    // lock hash
    expect(
    ...
    ).toBe('0x5de8c4d303266934f64be2acc928bbb82d07a34e9932dabcfa64761604fa15e5')
    expect(
      addPrefixForHash(
        '5de8c4d303266934f64be2acc928bbb82d07a34e9932dabcfa64761604fa15e5',
      ),
    ).toBe('0x5de8c4d303266934f64be2acc928bbb82d07a34e9932dabcfa64761604fa15e5')
    // address
    expect(
      addPrefixForHash('ckt1q9gry5zg8u2h8dzzrr2vz253jxd932rrheq4527rxr7493'),
    ).toBe('ckt1q9gry5zg8u2h8dzzrr2vz253jxd932rrheq4527rxr7493')
    // other
