...
export const HalvingTable = () => {
  ...
  return (
    <table className={styles.halvingTable}>
      <thead>
        <th>{t('halving.table_event')}</th>
        <th>{t('halving.table_date')}</th>
        <th>{t('halving.table_epoch_number')}</th>
        <th>{t('halving.table_epoch_reward')}</th>
        <th align="right">{t('halving.table_block_reward')}</th>
        <th align="right">{t('halving.table_daily_reward')}</th>
        <th align="right">{t('halving.table_total')}</th>
      </thead>
      <tbody>
        <tr>
          <td>{t('halving.table_launches')}</td>
          <td>16 Nov 2019</td>
          <td>0 ({t('halving.genesis_epoch')})</td>
          <td>1,917,808 CKB</td>
        ...
        <tr>
          ...
          <td>
            <strong>{t('halving.expected')} 19 Nov 2023</strong>
          </td>
          <td>
            <strong>8,760</strong>
          </td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2027</td>
          <td>17,520</td>
          <td>479,452 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2031</td>
          <td>26,280</td>
          <td>239,726 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2035</td>
          <td>35,040</td>
          <td>119,863 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2039</td>
          <td>43,800</td>
          <td>59,932 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2043</td>
          <td>52,560</td>
          <td>29,966 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2047</td>
          <td>61,320</td>
          <td>14,983 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2051</td>
          <td>70,080</td>
          <td>7,491 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2055</td>
          <td>78,840</td>
          <td>3,746 CKB</td>
        ...
        <tr>
          ...
          <td>{t('halving.expected')} November 2059</td>
          <td>87,600</td>
          <td>1,873 CKB</td>
