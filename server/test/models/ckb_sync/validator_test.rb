...
module CkbSync
  class ValidatorTest < ActiveSupport::TestCase
    ...
    test "should change cell output status from live to dead when it is used" do
      ...
      cell_output = previous_ckb_transaction.cell_outputs.create(capacity: 10**8)
