...
module CkbSync
  class PersistTest < ActiveSupport::TestCase
    ...
    test ".save_block generated transactions should has correct display input when previous_transaction_hash is not base" do
      ...
      fake_node_block = '{
        "transactions":[
          {"deps":[],"hash":"0xc30257c81dde7766fc98882ff1e9f8e95abbe79345982e12c6a849de90cbbad5","inputs":[{"args":["0x0700000000000000"],"previous_output":{"tx_hash":"0xc30257c81dde7766fc98882ff1e9f8e95abbe79345982e12c6a849de90cbbad1","index":0},"since":"0"}],"outputs":[{"capacity":"50000","data":"0x","lock":{"args":["0xc30257c81dde7766fc98882ff1e9f8e95abbe79345982e12c6a849de90cbbad1"],"code_hash":"0x8bddddc3ae2e09c13106634d012525aa32fc47736456dba11514d352845e561d"},"type":null}],"version":0,"witnesses":[]}
        ],
    ...
    test ".save_block generated block's miner hash should be nil when binary hash is invalid" do
      VCR.use_cassette("blocks/10") do
        SyncInfo.local_inauthentic_tip_block_number
        node_block = CkbSync::Api.instance.get_block(DEFAULT_NODE_BLOCK_HASH).deep_stringify_keys
        set_default_lock_params(node_block: node_block, code_hash: "0xc30257c81dde7766fc98882ff1e9f8e95abbe79345982e12c6a849de90cbbad1")
